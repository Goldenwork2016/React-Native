...
class Login extends Component {
  ...
  if (isAuth) {
    ...
    actions.toast('Please turn on app access to the camera in setup')
  }
})
				.catch((err) => {
  actions.toast('Get camera access error')
})
    }
  }
  ...
  _renderLoginButton () {
    ...
    return (
      <Icon.Button
        ...
        <Text style={styles.iconButtonText}>Sweep landing</Text>
      </Icon.Button>
    )
  }
        ...
        <View style={styles.content}>
          <View style={styles.info}>
            ...
            <Text style={styles.infoText}>
						The most professional Node.js open source technology community
						</Text>
